...
client.on('message', async (message) => {
    ...
    if (url.startsWith('https://www.tiktok.com/') || url.startsWith('https://vm.tiktok.com/')) {
        ...
        try {
            ...
            await message.reply("Starting download for your TikTok video... ⏳");
            
            // Download the TikTok video
            await downloadTikTokVideo(url, outputPath);
            await message.reply("Download completed! Preparing to send your video... ✅");
            ...
            if (fs.existsSync(outputPath)) {
                ...
                // Send the video as a media message (not as a document)
                await client.sendMessage(message.from, media);
                await message.reply("Here’s your TikTok video! 🎉");
            } else {
